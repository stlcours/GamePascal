...
procedure TMyGame.OnGetArchiveFilename(var aPassword: string; var aFilename: string);
begin
  //inherited;
...
begin
  inherited;
  Bitmap_Draw(FBmp, 240, 300, nil, @Vector(0.5, 0.5), @Vector(0.26, 0.26), FBmpAngle, WHITE, False, False);
...
begin
  ...
  Font_Print(DefaultFont, 240, 400, SKYBLUE, Align_Center, 18, 'Game Development System', []);
